...
3. Extensions & Novelty
    ...
    - Suggested by us:
      - Adapt the evaluation to more used encoders like Encodec [Arxiv paper](https://arxiv.org/pdf/2210.13438) and [huggingface](https://huggingface.co/facebook/encodec_32khz)